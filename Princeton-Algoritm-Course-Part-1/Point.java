...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point[] p = {new Point(1,1), new Point(2,2), new Point(5,2) , new Point(3,4) ,
        new Point(4,4), new Point(2,5),new Point(5,5),new Point(1,6),new Point(5,7)};
     ...
     /* BruteCollinearPoints col = new BruteCollinearPoints(p);
        StdOut.println(col.numberOfSegments());
        for (int x = 0; x < col.numberOfSegments(); x++)
        {
            StdOut.println(col.segments()[x]);
        }*/
